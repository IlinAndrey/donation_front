        ...
        <div className="items-center sm:flex">
          <div className="flex items-center">
            ...
            {isMenuOpen && (
              <div
                id="dropdown"
                className="absolute right-27 mt-[14rem] z-50 duration min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700"
              >
          ...
          <div date-rangepicker="" className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                name="start"
                type="text"
                className="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 datepicker-input"
                placeholder="From"
              />
            </div>
            <div className="relative">
      ...
      <div className="flex items-center justify-between pt-3 sm:pt-6">
        <div>
          ...
          >
            ...
            <svg
              className={`w-4 h-4 ml-2 transition-transform duration-200 ease-in-out 
            ${dateMenuOpen ? "" : "transform rotate-180"}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {dateMenuOpen && (
            <div className="absolute right- mt-[-21rem] duration min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700">
        ...
        <div className="flex-shrink-0">
          <a
            href="#"
            className="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-primary-700 sm:text-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
          >
            Transactions Report
            <svg
